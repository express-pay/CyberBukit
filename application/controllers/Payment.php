...
class Payment extends MY_Controller {
	...
	public function setting_action() {
		...
		(my_post('addons_pg_expresspay_one_time') == '1') ? $addons_pg_expresspay_one_time = '1' : $addons_pg_expresspay_one_time = 0;
		(my_post('addons_pg_expresspay_recurring') == '1') ? $addons_pg_expresspay_recurring = '1' : $addons_pg_expresspay_recurring = 0;
		...
		$payment_setting_array['expresspay_name'] = 'ExpressPay';
		$payment_setting_array['expresspay_one_time_enabled'] = $addons_pg_expresspay_one_time;
		$payment_setting_array['expresspay_recurring_enabled'] = $addons_pg_expresspay_recurring;
		$payment_setting_array['expresspay_is_test'] = my_post('addons_pg_expresspay_is_test');
		$payment_setting_array['expresspay_token'] = my_post('addons_pg_expresspay_token');
		$payment_setting_array['expresspay_service_id'] = my_post('addons_pg_expresspay_service_id');
		$payment_setting_array['expresspay_secret_word'] = my_post('addons_pg_expresspay_secret_word');
		$payment_setting_array['expresspay_is_use_signature_for_notification'] = my_post('addons_pg_expresspay_is_use_signature_for_notification');
		$payment_setting_array['expresspay_secret_word_notification'] = my_post('addons_pg_expresspay_secret_word_notification');
