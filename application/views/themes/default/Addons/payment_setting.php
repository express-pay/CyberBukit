    ...
    <div class="col-lg-8">
	  ...
	  <div class="card shadow mb-4">
        ...
        <div class="card-body">
		  ...
		  <div id="block_expresspay">
		    <div class="row form-group mb-4">
			  <div class="col-lg-6">
			    <label><b><?=my_caption('addons_payment_expresspay_setting')?></b></label>
				<div class="custom-control custom-checkbox mt-3">
				  <?php
				    (array_key_exists('expresspay_one_time_enabled', $payment_setting_array)) ? $checked = $payment_setting_array['expresspay_one_time_enabled'] : $checked = 0;
				    (set_value('addons_pg_expresspay_one_time') != '') ? $checked = set_value('addons_pg_expresspay_one_time') : null;
				      $data = array(
						'name' => 'addons_pg_expresspay_one_time',
						'id' => 'addons_pg_expresspay_one_time',
						'value' => '1',
						'checked' => $checked,
						'class' => 'custom-control-input'
					  );
					  echo form_checkbox($data);
				  ?>
				  <label class="custom-control-label" for="addons_pg_expresspay_one_time"><?php echo my_caption('global_enabled') . ' ' . my_caption('payment_type_one_time');?></label>
				</div>
			  </div>
			  <div class="col-lg-6">
				<label>&nbsp;</label>
				<div class="custom-control custom-checkbox mt-3">
				  <?php
				    (array_key_exists('expresspay_recurring_enabled', $payment_setting_array)) ? $checked = $payment_setting_array['expresspay_recurring_enabled'] : $checked = 0;
				    (set_value('addons_pg_expresspay_recurring') != '') ? $checked = set_value('addons_pg_expresspay_recurring') : null;
					$data = array(
					  'name' => 'addons_pg_expresspay_recurring',
					  'id' => 'addons_pg_expresspay_recurring',
					  'value' => '1',
					  'checked' => $checked,
					  'class' => 'custom-control-input'
					);
					echo form_checkbox($data);
				  ?>
				  <label class="custom-control-label" for="addons_pg_expresspay_recurring"><?php echo my_caption('global_enabled'). ' '. my_caption('payment_type_recurring');?></label>
				</div>
			  </div>
			</div>
			<div class="row form-group mt-4 mb-4">
			  <div class="col-lg-6">
				...
				<div class="custom-control custom-checkbox mt-3">
				  <?php
				    (array_key_exists('expresspay_is_test', $payment_setting_array)) ? $checked = $payment_setting_array['expresspay_is_test'] : $checked = 0;
				    (set_value('addons_pg_expresspay_is_test') != '') ? $checked = set_value('addons_pg_expresspay_is_test') : null;
				      $data = array(
						'name' => 'addons_pg_expresspay_is_test',
						'id' => 'addons_pg_expresspay_is_test',
						'value' => '1',
						'checked' => $checked,
						'class' => 'custom-control-input'
					  );
					  echo form_checkbox($data);
				  ?>
				  <label class="custom-control-label" for="addons_pg_expresspay_is_test"><?=my_caption('addons_payment_expresspay_is_test')?></label>
				</div>
			  </div>
			</div>
			<div class="row form-group mt-4 mb-4">
			  <div class="col-lg-12">
			    <label><span class="text-danger">*</span> <?=my_caption('addons_payment_expresspay_token')?></label>
				<?php
				  (array_key_exists('expresspay_token', $payment_setting_array)) ? $addons_payment_expresspay_token = $payment_setting_array['expresspay_token'] : $addons_payment_expresspay_token = '';
				  (set_value('addons_payment_expresspay_token') != '') ? $addons_payment_expresspay_token = set_value('addons_payment_expresspay_token') : null;
				  $data = array(
				    'name' => 'addons_pg_expresspay_token',
					'id' => 'addons_pg_expresspay_token',
					'value' => $addons_payment_expresspay_token,
					'class' => 'form-control'
				  );
				  echo form_input($data);
				  echo form_error('addons_pg_expresspay_token', '<small class="text-danger">', '</small>');
				?>
			  </div>
			</div>
			...
			<div class="row form-group mt-4 mb-4">
			  <div class="col-lg-6">
			    <label><span class="text-danger">*</span> <?=my_caption('addons_payment_expresspay_service_id')?></label>
				<?php
				  (array_key_exists('expresspay_service_id', $payment_setting_array)) ? $addons_payment_expresspay_service_id = $payment_setting_array['expresspay_service_id'] : $addons_payment_expresspay_service_id = '';
				  (set_value('addons_payment_expresspay_service_id') != '') ? $addons_payment_expresspay_service_id = set_value('addons_payment_expresspay_service_id') : null;
				  ($this->config->item('my_demo_mode')) ? $addons_payment_expresspay_service_id = '********' : null;
				  $data = array(
				    'name' => 'addons_pg_expresspay_service_id',
					'id' => 'addons_pg_expresspay_service_id',
					'value' => $addons_payment_expresspay_service_id,
					'class' => 'form-control'
				  );
				  echo form_input($data);
				  echo form_error('addons_pg_expresspay_service_id', '<small class="text-danger">', '</small>');
				?>
			  </div>
			  <div class="col-lg-6">
			    <label><?=my_caption('addons_payment_expresspay_secret_word')?></label>
				<?php
				  (array_key_exists('expresspay_secret_word', $payment_setting_array)) ? $addons_payment_expresspay_secret_word = $payment_setting_array['expresspay_secret_word'] : $addons_payment_expresspay_secret_word = '';
				  (set_value('addons_payment_expresspay_secret_word') != '') ? $addons_payment_expresspay_secret_word = set_value('addons_payment_expresspay_secret_word') : null;
				  $data = array(
				    'name' => 'addons_pg_expresspay_secret_word',
					'id' => 'addons_pg_expresspay_secret_word',
					'value' => $addons_payment_expresspay_secret_word,
					'class' => 'form-control'
				  );
				  echo form_input($data);
				  echo form_error('addons_pg_expresspay_secret_word', '<small class="text-danger">', '</small>');
				?>
			  </div>
			</div>
			<div class="row form-group mt-4 mb-4">
			...
			<div class="col-lg-6">
				...
				<div class="custom-control custom-checkbox mt-3">
				  <?php
				    (array_key_exists('expresspay_is_use_signature_for_notification', $payment_setting_array)) ? $checked = $payment_setting_array['expresspay_is_use_signature_for_notification'] : $checked = 0;
				    (set_value('addons_pg_expresspay_is_use_signature_for_notification') != '') ? $checked = set_value('addons_pg_expresspay_is_use_signature_for_notification') : null;
				      $data = array(
						'name' => 'addons_pg_expresspay_is_use_signature_for_notification',
						'id' => 'addons_pg_expresspay_is_use_signature_for_notification',
						'value' => '1',
						'checked' => $checked,
						'class' => 'custom-control-input'
					  );
					  echo form_checkbox($data);
				  ?>
				  <label class="custom-control-label" for="addons_pg_expresspay_is_use_signature_for_notification"><?=my_caption('addons_payment_expresspay_is_use_signature_for_notification')?></label>
				</div>
			  </div>
			  <div class="col-lg-6">
			    <label><?=my_caption('addons_payment_expresspay_secret_word_notification')?></label>
				<?php
				  (array_key_exists('expresspay_secret_word_notification', $payment_setting_array)) ? $addons_payment_expresspay_secret_word_notification = $payment_setting_array['expresspay_secret_word_notification'] : $addons_payment_expresspay_secret_word_notification = '';
				  (set_value('addons_payment_expresspay_secret_word_notification') != '') ? $addons_payment_expresspay_secret_word_notification = set_value('addons_payment_expresspay_secret_word_notification') : null;
				  $data = array(
				    'name' => 'addons_pg_expresspay_secret_word_notification',
					'id' => 'addons_pg_expresspay_secret_word_notification',
					'value' => $addons_payment_expresspay_secret_word_notification,
					'class' => 'form-control'
				  );
				  echo form_input($data);
				  echo form_error('addons_pg_expresspay_secret_word_notification', '<small class="text-danger">', '</small>');
				?>
			  </div>
			</div>
			<div class="row form-group mt-4 mb-4">
			  <div class="col-lg-6">
			    <label><?=my_caption('payment_paypal_webhook_url')?></label>
				<p class="mt-2"><u><?=base_url() . 'webhook/expresspay/'?></u></p>
			  </div>
			</div>
		  </div>
